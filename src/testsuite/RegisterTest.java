...
public class RegisterTest extends BaseTest {
    ...
    public void userShouldNavigateToRegisterPageSuccessfully() {
        ...
        //Enter first name
        driver.findElement(By.name("FirstName")).sendKeys("viral2");
        //Enter value in last name filed
        driver.findElement(By.id("LastName")).sendKeys("Patel");
        //Select date of birth
        driver.findElement(By.xpath("//select[@name='DateOfBirthDay']")).sendKeys("5");
        ...
        driver.findElement(By.xpath("//input[@id='Email' and @name='Email'] ")).sendKeys("test12@gmail.com");
        //Enter password
